            ...
            <div className="max-w-6xl mx-auto pt-16">
                    ...
                    <div>
                        <div className="flex items-center gap-4 mb-2">
                            <h1 className="text-4xl font-black text-gray-900 tracking-tighter">
                                Promotion <span className="text-black">Settings</span>
                            </h1>
                        ...
                        <p className="text-gray-500 text-lg">Manage dynamic discounts and seasonal offers across your fleet and excursions.</p>
                    </div>
                    <button 
                        onClick={() => openModal()}
                        className="flex items-center gap-2 px-6 py-3 bg-black hover:bg-gray-800 text-white text-white rounded-xl font-bold transition-all shadow-lg shadow-sm transform hover:-translate-y-1"
                    >
                ...
                {promotions.length === 0 ? (
                    <div className="text-center py-20 bg-white rounded-2xl border border-gray-200">
                        ...
                        <p className="text-gray-500 text-xl font-medium">No active promotions. Create one to boost sales!</p>
                    </div>
                ) : (
                        ...
                        {promotions.map((promo) => {
                            ...
                            return (
                                <div key={promo.id} className="bg-white border border-gray-200 rounded-2xl p-8 relative flex flex-col justify-between hover:shadow-2xl hover:shadow-black/5 transition-all duration-500 group">
                                    ...
                                    <div className="flex justify-between items-center mb-6">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[10px] font-black uppercase tracking-widest text-gray-900">
                                                {isActive ? 'Active Now' : isExpired ? 'Archived' : 'Upcoming'}
                                            </span>
                                        </div>
                                    ...
                                    {/* Content */}
                                    <div className="mb-8">
                                        <h3 className="text-2xl font-black text-gray-900 leading-tight mb-2 group-hover:text-black transition-colors">{promo.name || 'Untitled Promotion'}</h3>
                                    ...
                                    <div className="space-y-4 pt-6 border-t border-gray-100">
                                        <div className="flex flex-col gap-1">
                                            <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Validity Period</span>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">Promotion Name</label>
                                    <input 
                                        type="text" 
                                        required
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:outline-none focus:border-black transition-all font-black text-gray-900"
                                        value={formData.discount_percentage || 0}
                                        onChange={e => setFormData({...formData, discount_percentage: Number(e.target.value)})}
                                    />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-[11px] font-black text-gray-900 uppercase tracking-widest ml-1">Start Date</label>
                                    <input 
                                        type="date" 
                                        required
                                ...
                                <div className="space-y-2">
                                    <label className="text-[11px] font-black text-gray-900 uppercase tracking-widest ml-1">End Date</label>
                                    <input 
                                        type="date" 
                                        required
                                        className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:outline-none focus:border-black transition-all [color-scheme:light] font-bold"
                                ...
                                <div className="space-y-2">
                                    <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">Applies To</label>
                                    <select 
                                ...
                                <div className="space-y-2">
                                    <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">Scope</label>
                                    <select 
                                    ...
                                    {formData.applies_to_type === 'both' && (
                                        <p className="text-[10px] text-black mt-1">Specific scope is not available for "Both".</p>
                                    )}
                                </div>
                            </div>
                            ...
                            {formData.scope_type === 'specific' && formData.applies_to_type !== 'both' && (
                                <div className="space-y-3 pt-4 border-t border-gray-200">
                                    <label className="text-xs font-bold text-gray-500 uppercase tracking-widest block">Select Targets</label>
                                    <div className="max-h-48 overflow-y-auto bg-gray-50 rounded-xl border border-gray-200 p-2 grid grid-cols-1 sm:grid-cols-2 gap-2">
                                        ...
                                        {availableItems.length === 0 && (
                                            <div className="col-span-full p-4 text-center text-gray-500 text-sm">No items found to target.</div>
                                        )}
                                    </div>
                                </div>
                            )}
                            ...
                            <div className="pt-6 border-t border-gray-200 flex gap-4">
                                <button type="submit" className="flex-1 bg-black hover:bg-gray-800 text-white text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-sm">
