export default function ServiceDetail() {
    return (
        <div className="flex-1">
                ...
                <div className="absolute bottom-0 left-0 w-full p-6 sm:p-12">
                    <div className="max-w-7xl mx-auto">
                        <div className="flex flex-wrap gap-2 mb-4">
                            <span className="px-3 py-1 rounded-full bg-black text-white text-xs font-bold uppercase tracking-widest">Premium Collection</span>
                            <span className="px-3 py-1 rounded-full bg-gray-100 backdrop-blur-md text-gray-900 text-xs font-bold uppercase tracking-widest">Available Now</span>
                        </div>
                        <h2 className="text-4xl md:text-6xl font-black text-gray-900 mb-4 leading-tight">Coastal Amalfi Grand Tour</h2>
                        <p className="text-lg md:text-xl text-gray-800 max-w-2xl font-light">Experience the breath-taking Amalfi Coast in a custom-engineered masterpiece. Pure performance meets Mediterranean elegance.</p>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div className="flex flex-col gap-1 p-5 rounded-xl border border-slate-200 dark:border-gray-200 bg-white dark:bg-black/5">
                                <span className="material-symbols-outlined text-black mb-2">timer</span>
                                <p className="text-xs uppercase tracking-tighter text-gray-500 dark:text-gray-500 font-bold">Duration</p>
                                <p className="text-xl font-bold">8 Hours</p>
                            </div>
                            <div className="flex flex-col gap-1 p-5 rounded-xl border border-slate-200 dark:border-gray-200 bg-white dark:bg-black/5">
                                <span className="material-symbols-outlined text-black mb-2">distance</span>
                                <p className="text-xs uppercase tracking-tighter text-gray-500 dark:text-gray-500 font-bold">Distance</p>
                                <p className="text-xl font-bold">145 km</p>
                            </div>
                            <div className="flex flex-col gap-1 p-5 rounded-xl border border-slate-200 dark:border-gray-200 bg-white dark:bg-black/5">
                                <span className="material-symbols-outlined text-black mb-2">group</span>
                                <p className="text-xs uppercase tracking-tighter text-gray-500 dark:text-gray-500 font-bold">Capacity</p>
                                <p className="text-xl font-bold">2 Persons</p>
                            </div>
                            <div className="flex flex-col gap-1 p-5 rounded-xl border border-slate-200 dark:border-gray-200 bg-white dark:bg-black/5">
                                <span className="material-symbols-outlined text-black mb-2">speed</span>
                                <p className="text-xs uppercase tracking-tighter text-gray-500 dark:text-gray-500 font-bold">Difficulty</p>
                        ...
                        <section>
                            ...
                            <div className="prose prose-slate dark:prose-invert max-w-none text-gray-400 dark:text-gray-600 space-y-4 leading-relaxed">
                        ...
                        <section>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="flex items-start gap-3 p-4 rounded-lg bg-slate-100 dark:bg-white">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 dark:text-gray-500">Comprehensive protection for complete peace of mind.</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3 p-4 rounded-lg bg-slate-100 dark:bg-white">
                                    <span className="material-symbols-outlined text-black font-bold">check_circle</span>
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 dark:text-gray-500">24/7 assistance throughout your journey.</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3 p-4 rounded-lg bg-slate-100 dark:bg-white">
                                    <span className="material-symbols-outlined text-black font-bold">check_circle</span>
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 dark:text-gray-500">Curated refreshments and lunch included.</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3 p-4 rounded-lg bg-slate-100 dark:bg-white">
                                    <span className="material-symbols-outlined text-black font-bold">check_circle</span>
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 dark:text-gray-500">Digital album of your coastal adventure.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="relative h-64 w-full rounded-xl overflow-hidden bg-slate-200 dark:bg-white">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <div className="bg-background-dark/80 backdrop-blur px-6 py-3 rounded-full text-gray-900 border border-gray-200">
                                ...
                                <form className="space-y-4">
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input className="w-full rounded-lg border-slate-200 dark:border-gray-200 bg-slate-50 dark:bg-white py-3 pl-4 pr-10 text-sm focus:ring-black focus:border-black" type="date" />
                                            <span className="material-symbols-outlined absolute right-3 top-2.5 text-gray-500">calendar_month</span>
                                        </div>
                                    </div>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">Passengers</label>
                                            <select className="w-full rounded-lg border-slate-200 dark:border-gray-200 bg-slate-50 dark:bg-white py-3 text-sm focus:ring-black focus:border-black">
                                    ...
                                    <p className="text-center text-[10px] text-gray-500 uppercase tracking-widest mt-4">Free cancellation up to 48h before start</p>
                                </form>
                            </div>
                            {/* Secondary CTA */}
                            <div className="rounded-2xl bg-gray-100 border border-gray-200 p-6">
                                <p className="font-bold mb-2">Special Inquiry?</p>
                                <p className="text-sm text-gray-400 dark:text-gray-500 mb-4">Need a custom fleet or multi-day itinerary?</p>
                                <a className="text-sm font-bold text-black flex items-center gap-1 hover:underline" href="#">
            ...
            {/* Similar Experiences */}
            <section className="bg-slate-100 dark:bg-black/5 py-20 mt-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-end mb-10">
                        <div>
                            <h2 className="text-3xl font-black mb-2">Similar Adventures</h2>
                            <p className="text-gray-500 dark:text-gray-500">Curated by our expert drive masters</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {/* Card 1 */}
                        <div className="group overflow-hidden rounded-2xl bg-white dark:bg-background-dark border border-slate-200 dark:border-gray-200 transition-all hover:shadow-2xl">
